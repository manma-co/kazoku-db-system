...
function remindReport(){
  ...
  const mMail = (function() {
    return {
      subject: function() { return "【manma】家族留学事後対応のご確認" },
      body: function(name) {
        if (name === '') { return '' }
        return name + "さま\n\n"
        + "お世話になっております、manmaです。\n"
        + "先日ご案内いたしましたアンケート及び受け入れ家庭へのお礼メールはお済みでしょうか。\n"
        + "\n"
        + "家族留学は\n"
        + "●ご家庭へのお礼メールの送付\n"
        + "●アンケートの回答\n"
        + "https://forms.gle/hY2cdxjDg3sm8Fiq6\n"
        + "以上を対応していただいたのち、正式に終了とさせていただきますので、お済みでない方はご対応お願いいたします。\n"
        + "※システムの関係上、既にご対応済みの方へもこのメールが届く場合がございます。\n"
