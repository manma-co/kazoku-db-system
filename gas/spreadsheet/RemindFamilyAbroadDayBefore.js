...
いよいよ明日は家族留学です！\n\
\n\
再度、【集合場所・時間】をご確認の上、遅刻がないようお気をつけください。\n\
◆家族留学実施概要◆\n\
実施日：@@\n\
集合時間：@@\n\
集合場所：@@\n\
...
以下は当日の注意事項です。\n\
\n\
  ●ご家庭の方と合流した際にmanmaの方に報告メールをお願いいたします。\n\
\n\
  ●解散する前に、家族留学中のお写真と解散報告メールをmanmaに送ってください。\n\
\n\
  ●解散後、受け入れ家庭の方にお礼メールを忘れずに送るようにしてください。\n\
その際、manmaをccに入れるのを忘れないようにお願い致します。\n\
\n\
  ●家族留学後にmanmaの方に送られるメールのURLより、家族留学報告レポートの提出をよろしくお願い致します。\n\
\n\
上記5点、どうぞよろしくお願いいたします。\n\
\n\
