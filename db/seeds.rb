...
locations.each_with_index do |location, i|
  ...
  family = ProfileFamily.create(user_id: user.id, job_style: 1, number_of_children: i+1, is_photo_ok: 1, is_sns_ok: 1, is_male_ok: 1)
  individual = ProfileIndividual.create(profile_family_id: family.id, birthday: "Fri, #{i+1} Dec 2011 00:00:00 +0000", job_domain_id: i+1, role: 1)
end
