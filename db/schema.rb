...
ActiveRecord::Schema.define(version: 2020_02_13_163120) do
  ...
  create_table "email_queues", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["study_abroad_id"], name: "index_email_queues_on_study_abroad_id"
  end
  ...
  create_table "event_dates", force: :cascade do |t|
    ...
    t.index ["study_abroad_id"], name: "index_event_dates_on_study_abroad_id"
